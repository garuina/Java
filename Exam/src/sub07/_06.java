...
class _Student extends _Person {
	...
	public void Hello() {
		...
		System.out.println("선생 : " + major);
	};
}

class _SalaryStudents extends _Student {
	private String company;
	
	public _SalaryStudents(String name , int age, String school, String major, String company) {
...
public class _06 {
	public static void main(String[] args) {
		...
		_SalaryStudents lee = new _SalaryStudents("이순신", 27, "부산대", "경제학과", "삼성전자");
